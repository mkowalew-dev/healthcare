...
CREATE INDEX IF NOT EXISTS idx_lis_orders_provider ON lis_orders(provider_id);
CREATE INDEX IF NOT EXISTS idx_lis_orders_patient ON lis_orders(patient_id);
